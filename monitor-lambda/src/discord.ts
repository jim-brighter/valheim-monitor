 ...
 *
 * @param secrets - Secrets containing channel_id, token, and user_agent
 * @param messageContent - The content string to post
 * @returns Fetch response
 */
export async function sendDiscordMessage(secrets: MonitorSecrets, messageContent: string): Promise<Response> {
